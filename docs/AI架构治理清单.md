...
# 按 .github/workflows/aicopilot-ci.yml 执行 inventory 中全部 17 个 required runner：Pure/InProcess 并行收集 coverage，资源 runner 串行，全部输出 TRX。
