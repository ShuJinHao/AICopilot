...
- GeneratedAt: 2026-05-22 11:30:06
...
已通过! - 失败:     0，通过:     5，已跳过:     0，总计:     5，持续时间: 195 ms - AICopilot.BackendTests.dll (net10.0)
```
...
已通过! - 失败:     0，通过:    26，已跳过:     0，总计:    26，持续时间: 2 s - AICopilot.BackendTests.dll (net10.0)
```
