...
$reportLines.Add("- LocalHead: $($gitSummary.Head)")
$reportLines.Add("- Branch: $($gitSummary.Branch)")
$reportLines.Add("- WorkingTree: $($gitSummary.WorkingTree)")
$reportLines.Add("- PullRequest: $($gitSummary.PullRequest)")
$reportLines.Add("- GitHubCI: $($gitSummary.Ci) (covers the current PR head only; rerun after committing and pushing local P15 changes)")
