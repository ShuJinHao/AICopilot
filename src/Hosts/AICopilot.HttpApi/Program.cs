...
var serviceName = Environment.GetEnvironmentVariable("OTEL_SERVICE_NAME") ?? nameof(AICopilot.HttpApi);
...
Sdk.CreateTracerProviderBuilder()
    ...
    .AddSource(nameof(AICopilot.AiGatewayService))     // 监听我们自己业务代码的 Activity
