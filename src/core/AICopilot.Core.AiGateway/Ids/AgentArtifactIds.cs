...
[StronglyTypedGuidId("Agent node run id is required.")] public readonly partial record struct AgentNodeRunId;
[StronglyTypedGuidId("Agent evidence record id is required.")] public readonly partial record struct AgentEvidenceRecordId;
[StronglyTypedGuidId("Agent run usage ledger entry id is required.")] public readonly partial record struct AgentRunUsageLedgerEntryId;
[StronglyTypedGuidId("Agent node reconciliation decision id is required.")] public readonly partial record struct AgentNodeReconciliationDecisionId;
[StronglyTypedGuidId("Model quota reservation id is required.")] public readonly partial record struct ModelQuotaReservationId;
[StronglyTypedGuidId("Artifact file-set operation id is required.")] public readonly partial record struct ArtifactFileSetOperationId;
