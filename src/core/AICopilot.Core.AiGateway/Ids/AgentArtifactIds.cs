...
public readonly record struct AgentNodeRunId : IStronglyTypedGuidId
{
    public AgentNodeRunId(Guid value)
    {
        if (value == Guid.Empty)
        {
            throw new ArgumentException("Agent node run id is required.", nameof(value));
        }
    ...
    public static AgentNodeRunId New() => new(Guid.NewGuid());

    public static implicit operator Guid(AgentNodeRunId id) => id.Value;

    public override string ToString() => Value.ToString();
}

public readonly record struct AgentEvidenceRecordId : IStronglyTypedGuidId
{
    public AgentEvidenceRecordId(Guid value)
    {
        if (value == Guid.Empty)
        {
            throw new ArgumentException("Agent evidence record id is required.", nameof(value));
        }
    ...
    public static AgentEvidenceRecordId New() => new(Guid.NewGuid());

    public static implicit operator Guid(AgentEvidenceRecordId id) => id.Value;

    public override string ToString() => Value.ToString();
}

public readonly record struct AgentRunUsageLedgerEntryId : IStronglyTypedGuidId
{
    public AgentRunUsageLedgerEntryId(Guid value)
    {
        if (value == Guid.Empty)
        {
            throw new ArgumentException("Agent run usage ledger entry id is required.", nameof(value));
        }
    ...
    public static AgentRunUsageLedgerEntryId New() => new(Guid.NewGuid());

    public static implicit operator Guid(AgentRunUsageLedgerEntryId id) => id.Value;

    public override string ToString() => Value.ToString();
}

public readonly record struct AgentNodeReconciliationDecisionId : IStronglyTypedGuidId
{
    public AgentNodeReconciliationDecisionId(Guid value)
    {
        if (value == Guid.Empty)
        {
            throw new ArgumentException("Agent node reconciliation decision id is required.", nameof(value));
        }
    ...
    public static AgentNodeReconciliationDecisionId New() => new(Guid.NewGuid());

    public static implicit operator Guid(AgentNodeReconciliationDecisionId id) => id.Value;

    public override string ToString() => Value.ToString();
}

public readonly record struct ModelQuotaReservationId : IStronglyTypedGuidId
{
    public ModelQuotaReservationId(Guid value)
    {
        if (value == Guid.Empty)
        {
            throw new ArgumentException("Model quota reservation id is required.", nameof(value));
        }
    ...
    public static ModelQuotaReservationId New() => new(Guid.NewGuid());

    public static implicit operator Guid(ModelQuotaReservationId id) => id.Value;

    public override string ToString() => Value.ToString();
}

public readonly record struct ArtifactFileSetOperationId : IStronglyTypedGuidId
{
    public ArtifactFileSetOperationId(Guid value)
    {
        if (value == Guid.Empty)
        {
            throw new ArgumentException("Artifact file-set operation id is required.", nameof(value));
        }
    ...
    public static ArtifactFileSetOperationId New() => new(Guid.NewGuid());

    public static implicit operator Guid(ArtifactFileSetOperationId id) => id.Value;
