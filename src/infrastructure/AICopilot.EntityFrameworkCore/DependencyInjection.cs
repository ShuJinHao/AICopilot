...
public static class DependencyInjection
{
    public static void AddEfCore(this IHostApplicationBuilder builder)
    {
        ...
        builder.Services.AddScoped<IReadRepository<MessageEvent>>(provider => provider.GetRequiredService<AiGatewayRepository<MessageEvent>>());
        builder.Services.AddScoped<IRepository<MessageEvent>>(provider => provider.GetRequiredService<AiGatewayRepository<MessageEvent>>());
        ...
        builder.Services.AddScoped<IReadRepository<AgentTaskRunAttempt>>(provider => provider.GetRequiredService<AiGatewayRepository<AgentTaskRunAttempt>>());
        builder.Services.AddScoped<IRepository<AgentTaskRunAttempt>>(provider => provider.GetRequiredService<AiGatewayRepository<AgentTaskRunAttempt>>());
        builder.Services.AddScoped<IReadRepository<AgentTaskRunQueueItem>>(provider => provider.GetRequiredService<AiGatewayRepository<AgentTaskRunQueueItem>>());
        builder.Services.AddScoped<IRepository<AgentTaskRunQueueItem>>(provider => provider.GetRequiredService<AiGatewayRepository<AgentTaskRunQueueItem>>());
        builder.Services.AddScoped<IReadRepository<AgentWorkerHeartbeat>>(provider => provider.GetRequiredService<AiGatewayRepository<AgentWorkerHeartbeat>>());
        builder.Services.AddScoped<IRepository<AgentWorkerHeartbeat>>(provider => provider.GetRequiredService<AiGatewayRepository<AgentWorkerHeartbeat>>());
        ...
        builder.Services.AddScoped<IReadRepository<ToolExecutionRecord>>(provider => provider.GetRequiredService<AiGatewayRepository<ToolExecutionRecord>>());
