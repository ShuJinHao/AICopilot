...
public static class DependencyInjection
{
    public static void AddEfCore(this IHostApplicationBuilder builder)
    {
        ...
        builder.Services.AddScoped<IReadRepository<PromptPolicy>>(provider => provider.GetRequiredService<AiGatewayRepository<PromptPolicy>>());
        builder.Services.AddScoped<IRepository<PromptPolicy>>(provider => provider.GetRequiredService<AiGatewayRepository<PromptPolicy>>());
