...
internal static class CloudReadonlyPilotReadinessContractRehearsal
{
    private static readonly IReadOnlyDictionary<string, CloudReadonlyPilotReadinessEndpointSpec> EndpointSpecs =
        new[]
        {
            ...
            new CloudReadonlyPilotReadinessEndpointSpec("pass_station_records", HttpMethod.Get, "/api/v1/ai/read/pass-stations/default", 2),
            new CloudReadonlyPilotReadinessEndpointSpec("recipe", HttpMethod.Get, "/api/v1/ai/read/recipes", 0, IsBlockedByPolicy: true),
            new CloudReadonlyPilotReadinessEndpointSpec("recipe_versions", HttpMethod.Get, "/api/v1/ai/read/recipes/versions", 0, IsBlockedByPolicy: true),
