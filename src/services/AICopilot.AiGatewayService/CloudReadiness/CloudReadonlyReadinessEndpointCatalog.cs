...
internal static class CloudReadonlyReadinessEndpointCatalog
{
    private static readonly IReadOnlyDictionary<string, CloudReadonlyReadinessEndpointSpec> EndpointSpecs =
        new[]
        {
            ...
            new CloudReadonlyReadinessEndpointSpec("pass_station_records", HttpMethod.Get, "/api/v1/ai/read/pass-stations/default", 2),
            new CloudReadonlyReadinessEndpointSpec("recipe", HttpMethod.Get, "/api/v1/ai/read/recipes", 0, IsBlockedByPolicy: true),
            new CloudReadonlyReadinessEndpointSpec("recipe_versions", HttpMethod.Get, "/api/v1/ai/read/recipes/versions", 0, IsBlockedByPolicy: true),
