...
internal static class CloudReadonlySandboxControlledTrialQueryProjection
{
    public static IReadOnlyDictionary<string, string?> BuildQuery(CloudSandboxGoalIntentDto intent, int maxRows)
    {
