...
public sealed class PermissionCatalog : IPermissionCatalog
{
    ...
    [
        ...
        new("AiGateway.GetRoutingModel", "AiGateway", "View Routing Model", "View routing model configuration details."),
        new("AiGateway.GetListRoutingModels", "AiGateway", "View Routing Models", "View the routing model configuration list."),
        new("AiGateway.CreateRoutingModel", "AiGateway", "Create Routing Model", "Create a routing model configuration."),
        new("AiGateway.UpdateRoutingModel", "AiGateway", "Update Routing Model", "Update or activate a routing model configuration."),
        new("AiGateway.DeleteRoutingModel", "AiGateway", "Delete Routing Model", "Delete a routing model configuration."),
        ...
        new("DataSource.Query", "DataSource", "Query Data Sources", "Run approved read-only Text-to-SQL queries against authorized data sources."),
