...
namespace AICopilot.Services.Contracts.Data;

public static class CloudReadOnlyBusinessDatabaseSeedPolicy
{
    public const string SectionPath = "DataAnalysis:CloudReadOnly";
    ...
    public static CloudReadOnlyBusinessDatabaseOptions ResolveOptions(IConfiguration configuration)
    {
    ...
    public static BusinessDatabase CreateBusinessDatabase(CloudReadOnlyBusinessDatabaseOptions options)
    {
    ...
    public static void UpdateBusinessDatabase(
    ...
    private static string GetValue(IConfigurationSection section, string key, string fallback)
    {
        return string.IsNullOrWhiteSpace(section[key]) ? fallback : section[key]!.Trim();
    }
...
public sealed record CloudReadOnlyBusinessDatabaseOptions(
    bool Enabled,
    string DatabaseName,
    string Description,
